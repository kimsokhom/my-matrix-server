...
envsubst '$SERVER_NAME $POSTGRES_USER $POSTGRES_PASSWORD $POSTGRES_HOST $POSTGRES_PORT $TELEGRAM_DB_NAME $TELEGRAM_AS_TOKEN $TELEGRAM_HS_TOKEN $TELEGRAM_API_ID $TELEGRAM_API_HASH $REGISTRATION_SHARED_SECRET $SYNAPSE_INTERNAL_URL $TELEGRAM_BRIDGE_URL $ADMIN_MXID' \
